...
var jumpS, collideS, cpS
 //var message = " Max is doing great in his coding classes";
...
function preload(){
  ...
  ts = loadAnimation("wingUp.jpg" , "wingDown.jpg");
...
function draw() {
  ...
  text("High Score: " + localStorage[hiScore], 400, 50)
